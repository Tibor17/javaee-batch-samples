...
@Named
public class BadBatch extends AbstractBatchlet implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(BadBatch.class);
    ...
    public String process() throws Exception {
        ...
        stepContext.setPersistentUserData("persistent user data [bad]");
        System.out.println("bad batch. Transaction status " + ut.getStatus());
        ...
        throw new IllegalArgumentException("bad batch failed");
