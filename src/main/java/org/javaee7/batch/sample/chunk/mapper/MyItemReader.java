...
public class MyItemReader extends AbstractItemReader {
    ...
    public void open(Serializable e) throws Exception {
        context.setTransientUserData("my transient data");
        System.out.println("myItemReader open(" + e + ") transaction status " + ut.getStatus());
        System.out.println("reader.open " + bean.getX() + ":" + bean.setX(1) + ", readerId=" + readerId);
        ...
        System.out.println("tokens = " + builder);
    }

    @Override
    public MyInputRecord readItem() throws Exception {
        System.out.println("reader.readItem " + bean.getX() + ":" + bean.setX(2));
